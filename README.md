...
> 纯文本 DeepSeek，终于找到眼睛捐赠者了——豆包！👀

DeepSeek Harness（DSH）视觉插件：通过 **Edge 浏览器 + 豆包网页版** 给纯文本模型提供识图能力。**零成本、免 API Key**——DeepSeek 负责思考，豆包负责看。

- 🧮 **数学建模图专项**：几何图形 / 流程图 / 数据图表 / 表格 / 公式 的深度结构化识别
